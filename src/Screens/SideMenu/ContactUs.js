                ...
                <View style={{ width: '100%', alignItems: 'center' }}>
                    <View style={{ width: scr_width }}>
                        <Image
                            ...
                            style={{ width: scr_width, height: 220, resizeMode: 'contain', }}
                        />
                    </View>

                    <View style={{ width: '95%', paddingTop: 20 }}>
                        <Text style={{ width: '100%', fontSize: 14, color: '#666', fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22, paddingVertical: 10, }}>
                            MR Brothers is one of the fast-growing authorized dealers, with our
                            wings widespread in India, Singapore, and Malaysia. Presenting in
                            simple verbs, MR Brothers is a one-stop shop for all customer
                            requirements. MR Brothers aims to give customers in India,
                    ...
                    <View style={{ width: '95%' }}>
                        ...
                        <Text
                            ...
                            The value proposition of MR Brothers pivots around giving buyers an
                    ...
                    <View style={{ width: '95%' }}>
                        ...
                        <Text
                            ...
                            MR Brothers includes a vast selection of products from various
